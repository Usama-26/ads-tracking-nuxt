          ...
          <div class="p-4 lg:w-1/4 sm:w-1/2">
            <div class="h-full flex flex-col items-center text-center">
              ...
              <div class="w-full">
                ...
                <h3 class="text-gray-500 mb-3">CEO & Gründer</h3>
              </div>
            </div>
          </div>
          <div class="p-4 lg:w-1/4 sm:w-1/2">
            <div class="h-full flex flex-col items-center text-center">
              ...
              />
              <div class="w-full">
                <h2 class="title-font font-medium text-lg text-gray-900">Sophia Becker</h2>
                <h3 class="text-gray-500 mb-3">CRO</h3>
              </div>
            </div>
          </div>
          <div class="p-4 lg:w-1/4 sm:w-1/2">
            <div class="h-full flex flex-col items-center text-center">
              ...
              />
              <div class="w-full">
                <h2 class="title-font font-medium text-lg text-gray-900">Ben Simon</h2>
                <h3 class="text-gray-500 mb-3">Technischer Projektleiter</h3>
              </div>
            </div>
          </div>
          <div class="p-4 lg:w-1/4 sm:w-1/2">
            <div class="h-full flex flex-col items-center text-center">
              ...
              />
              <div class="w-full">
                <h2 class="title-font font-medium text-lg text-gray-900">Emilia Voigt</h2>
                <h3 class="text-gray-500 mb-3">Web-Tracking-Ingenieur</h3>
              </div>
            </div>
          </div>
        </div>
