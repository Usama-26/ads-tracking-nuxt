      ...
      <div class="flex flex-col w-full lg:mb-20 mb-10">
        <div class="mx-8 lg:mx-20">
          <h1 class="sm:text-4xl text-3xl font-bold title-font text-gray-900">
            Die effektive Lösung zu Ihrem Track­ing Problem
          </h1>
          <span class="inline-block h-1 w-20 mt-4 rounded bg-green-500"></span>
        </div>
        <div class="flex flex-wrap lg:mx-20 mx-8 font-medium gap-24 mt-20">
          <div
          ...
          <div class="mx-auto">
            <img src="https://dummyimage.com/400x300&text=VIDEO" alt="VIDEO" />
          </div>
        </div>
      </div>
    </div>
