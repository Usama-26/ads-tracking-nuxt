  ...
  <section class="text-gray-600 body-font bg-gray-200">
    <div class="container px-5 py-24 mx-auto">
      <div class="flex flex-col w-full lg:mb-20 mb-10">
        <h1
          class="sm:text-4xl text-3xl lg:mx-20 font-bold title-font text-gray-900"
        >
      ...
      <div class="flex flex-wrap lg:gap-0 gap-8 justify-evenly">
          ...
          >
            ...
            <div class="flex-grow">
              <p class="leading-relaxed lg:w-4/5 sm:w-3/5 w-full mx-auto">
                Mit Serverside-Tracking sehen Sie auf einmal wieder 99% der
                Daten. KPIs können wieder korrekt getrackt und Potenziale zur
                Verbesserung voll ausgeschöpft werden.
              </p>
            </div>
          </div>
        </div>
        <div class="lg:w-1/4 w-full">
          ...
          >
            ...
            <div class="flex-grow">
              <p class="leading-relaxed lg:w-4/5 sm:w-3/5 w-full mx-auto">
                Durch eine vollständige Erfassung der Conversions kann der
                Algorithmus besser lernen und optimieren. Im Ergebnis erzielen
                Sie bessere Umsätze bei gleichem Budget.
              </p>
            </div>
          </div>
        </div>
        <div class="lg:w-1/4 w-full">
          ...
          >
            ...
            <div class="flex-grow">
              <p class="leading-relaxed lg:w-4/5 sm:w-3/5 w-full mx-auto">
                Serverseitiges Tracking ist noch nicht besonders verbreitet.
                Wenn Sie jetzt darauf setzen, können Sie sich wohlmöglich einen
                wichtigen Wettbewerbsvorteil erarbeiten.
              </p>
            </div>
          </div>
        </div>
