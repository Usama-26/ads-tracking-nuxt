  ...
  <section class="text-gray-600 body-font">
    <div class="container px-5 py-24 mx-auto">
      ...
      >
        ...
        <button
          class="flex-shrink-0 text-green-500 py-2 px-8 focus:outline-none hover:bg-green-600 hover:text-white rounded-full border-2 border-green-600 text-lg mt-10 sm:mt-0"
        >
          Contact
        </button>
      </div>
